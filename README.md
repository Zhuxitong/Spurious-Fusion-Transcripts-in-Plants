# Custom Scripts for "The Hidden Sources of Spurious Fusion Transcripts in Plants"

This repository contains the custom scripts developed for the study: **"The Hidden Sources of Spurious Fusion Transcripts in Plants"**. 

These tools are specifically designed to address the challenges of identifying and validating fusion transcripts in plants, with a focus on distinguishing true biological fusions from technical artifacts.
...
* **Publication Figures:** Custom plotting scripts used to generate manuscript figures.

---

## ⚙️ Requirements & Dependencies

Most scripts are written in **Perl**, **R**, and **Bash**.
