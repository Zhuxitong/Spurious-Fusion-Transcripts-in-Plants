...
#
# Purpose:
# This script contains representative R code used for the
# statistical analyses and figure generation in the study:
#
#   The Hidden Sources of Spurious Fusion Transcripts in Plants
#
# The script is provided to illustrate how the main plots and
# summary statistics were generated, and to improve the
# transparency of the analytical workflow.
#
# Important Note:
# This file is intended primarily as a reference for figure
# plotting and statistical procedures. Some original plotting
# datasets are not bundled within this repository because of
# size, formatting, or project organization constraints.
#
# If specific source tables or plotting inputs are required
# for reproduction of individual figures, please contact the
# corresponding authors and we would be happy to provide them
# where appropriate.
#
# Scope:
# - Data visualization
...
# - Supplementary plotting utilities
#
# This script is not intended to function as a single-click
# standalone pipeline, but rather as a transparent collection
# of the R code used to generate manuscript figures.
############################################################
...
# Fig. 1c. Number of fusion transcripts across categories
...
# Fig. 1d. Numbers of inter-chromosomal and intra-chromosomal fusions
...
# Fig. 1f. Venn diagram showing overlap with 3D interaction datasets
...
# Fig. 2h. Fluorescence intensity quantification
...
# Fig. 3a. Expression levels of parental genes among breakpoint categories
...
# Fig. 3b. Length distribution of Unknown-type fusions
...
# Fig. 3c. GC content of Unknown-type fusions
...
# Fig. 3d. Origins of Unknown-type sequences
...
# Fig. 3e. Number of Joined-type fusions
...
# Fig. 3f. Alignment and coverage characteristics of Joined-type fusions
library(ggExtra)
...
# Fig. 3h. Trans-splicing and Helitron-related signals
...
# Fig. 3i. Fusion categories before and after read correction
p <- data.frame(
  stringsAsFactors = FALSE,
...
# Fig. 3j. Misaligned fusion alignment types and lengths
...
# Fig. 4a. Breakpoint composition and network analysis
break_type_new %>% 
    select(tech, bp_new) %>% 
...
# Fig. 4b. Degree distribution of parental genes in the fusion network
...
# Fig. 4f. Fusion categories involving OsMH_10G0000800
...
# Fig. 5a. Fusion categories detected from RNA-seq
...
# Fig. S1b. Read counts across sequencing platforms
...
# Fig. S1c. Average read lengths across sequencing platforms
...
# Fig. S1d. Correlations among sequencing datasets
...
# Fig. S1e. Genome alignment coverage
...
# Fig. S1f. Transcript classifications across sequencing platforms
...
# Fig. S3a. Venn diagram of overlapping fusions across sequencing platforms
...
# Fig. S3c. Numbers of reproducible cDNA fusion transcripts
p <- data.frame(
  stringsAsFactors = FALSE,
                type = c("HC", "LC", "NS", "PRT"),
                num = c(1L, 4L, 14L, 0L)
...
# Fig. S3d-e. Overlap of fusion calls among different tools
p <- data.frame(
  stringsAsFactors = FALSE,
  type = c("HC", "LC", "NS", "PRT"),
  num = c(1L, 3L, 100L, 0L)
...
# Fig. S4a-b. Distribution of fusion numbers in Nipponbare datasets
library(janitor)
...
# Fig. S5a. SHS length distribution
...
# Fig. S5b. SHS sequence frequency
...
# Fig. S5d. Tissue-specific occurrence of SHS events
...
# Fig. S10a-b. Alignment score and minimum alignment length
...
# Fig. S10c. Parental coverage of Misaligned-type fusions
...
# Fig. S10d. Parental gene similarity of Misaligned-type fusions
...
# Fig. S13c. Comparison of gene numbers across annotation versions
...
# Fig. S13d. Numbers of fused and split gene models
p <- data.frame(
  stringsAsFactors = FALSE,
       check.names = FALSE,
...
# Fig. S14b. Number of fusions after remapping ZS97 dRNA reads to the ZS97 genome
...
# Fig. S18b. Number of trans-mate pairs
p <- data.frame(
  stringsAsFactors = FALSE,
...
# Fig. S18c. Correlation between SY63 and mixed-parent controls
...
# Fig. S18d. Number of genes supported by trans-mate pairs
p <- data.frame(
  stringsAsFactors = FALSE,
...
# Fig. S18f. Correlation between RNA-seq and Iso-Seq
...
# Fig. S18g. Number of allelic fusion candidates
...
# Fig. S18h. Number of non-allelic fusion candidates
